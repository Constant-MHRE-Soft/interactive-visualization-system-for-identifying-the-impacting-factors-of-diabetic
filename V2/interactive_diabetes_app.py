...
# ====================================================================================
if page == "📊 Dashboard":
    st.markdown("<h1 style='text-align: center;'>🩺 An interactive visualization system to understand patterns for identifying the impacting factors of diabetic diseases </h1>", unsafe_allow_html=True)
    st.markdown("<p style='text-align: center;'>A simple dashboard showing trends and insights from collected diabetes data</p>", unsafe_allow_html=True)
    st.markdown(f"<p style='text-align: right;'>📅 {datetime.now().strftime('%B %d, %Y - %I:%M %p')}</p>", unsafe_allow_html=True)
...
# ====================================================================================
    ...
    df = load_external_data(uploaded_file) if uploaded_file else load_monthly_data()
